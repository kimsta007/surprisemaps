...
function c_identify(){
    ...
    {
        title: 'Surprise Map',
        text: 'This Surprise Map shows the surprise by county for the USA. <br/> Note: You can pan the map by clicking on it then dragging the map left or right.',
        attachTo: {
            element: '#visuals',
            on: 'left'
        },
...

    {
        ...
        text: '<b>Select the lowest 5 counties by clicking each county on the map.</b>',
        attachTo: {
            element: '#visuals',
            on: 'bottom'
        },
    ...
    {
        title: 'All Set!',
        text: 'You are all set and ready to continue. <br/><b>Click Continue!</b>',
        attachTo: {
            on: 'center'
        },
        buttons: [{
...
function s_identify(){
    ...
    {
        title: 'Select counties',
        text: '<b>Select the highest 5 counties by clicking each county on the map.</b>',
        attachTo: {
            element: 'svg',
            on: 'bottom'
        },
...
function c_explore(){
    ...
    {
        title: 'Narrative',
        text: '<b>Provide a short narrative of vaccine rollout.</b>',
        attachTo: {
            element: '#summary',
            on: 'top'
        },
